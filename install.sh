...
wget https://github.com/Vaigyanik-Jinger/pdfer/blob/main/simpics.py
wget https://github.com/Vaigyanik-Jinger/pdfer/blob/main/vid_notes.sh
wget https://github.com/Vaigyanik-Jinger/pdfer/blob/main/pdfer.sh
